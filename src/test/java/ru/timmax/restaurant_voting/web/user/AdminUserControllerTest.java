...
import static ru.timmax.restaurant_voting.web.user.AdminUserController.REST_URL;
import static ru.timmax.restaurant_voting.web.user.UniqueMailValidator.EXCEPTION_DUPLICATE_EMAIL;
import static ru.timmax.restaurant_voting.web.user.UserTestData.*;
